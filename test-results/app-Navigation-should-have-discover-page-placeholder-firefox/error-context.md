...
- Name: app.spec.ts >> Navigation >> should have discover page placeholder
- Location: e2e\app.spec.ts:163:3
...
Call log:
  - navigating to "http://localhost:3000/discover", waiting until "load"
