...
- Name: app.spec.ts >> Home Page >> should display feature list
...
Locator: locator('text=Secure email/password authentication')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Secure email/password authentication')
