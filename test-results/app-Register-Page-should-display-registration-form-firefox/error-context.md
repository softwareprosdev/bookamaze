...
- Name: app.spec.ts >> Register Page >> should display registration form
...
Locator: locator('h2')
Expected substring: "Get started"
Timeout: 5000ms
...
```yaml
- generic [ref=e3]:
  - generic [ref=e4]: "An error occurred while server rendering /register: (intermediate value).default.fetch is not a function"
